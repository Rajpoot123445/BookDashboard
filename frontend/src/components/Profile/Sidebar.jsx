...
const Sidebar = ({ detail }) => {
    ...
    return (
        <div className='bg-slate-900 py-4 md:h-[88vh] rounded-md flex flex-col justify-between'>
            <div className='flex flex-col items-center gap-2'>
                <img src={detail.avatar} alt="Role" className='w-[25vw] md:w-1/2' />
            ...
            </div>
            {
                detail.role === "user" ?
                    ...
                    :
                    <div className='w-full flex flex-row md:flex-col px-6 py-4 md:p-0 items-center gap-2'>
                        <Link to='/profile' className=' hover:bg-slate-700 w-[95%] font-semibold text-center p-3 rounded-md ' >
                            All Orders
                        </Link>
                        <Link to='/profile/addBook' className=' hover:bg-slate-700 w-[95%] font-semibold text-center p-3 rounded-md ' >
                            Add Books
                        </Link>
                    </div>
            }
